...
.equ MULTICOLOUR_SCREEN_COUNT, 1
...
# };
.equ FLI_MULTICOLOUR_PTR_OFFSET, 0
.equ FLI_D021_COLOURS_PTR_OFFSET, 8

.equ FLI_TOTAL_SIZE, 16

.equ FLI_SCREEN_COUNT, 8
...
#   uint16_t data_length;
#   uint16_t bitmap_offset;
#   uint16_t screens_offset;
#   uint16_t colours_offset;
#   uint16_t border_colour_offset;
#   uint16_t screen_size;
#   ByteArray *(*get_d021_colours_fun)(std::byte *);
# };
.equ FLI_CONFIG_FORMAT_DESCRIPTION_OFFSET, 0
.equ FLI_CONFIG_LOAD_ADDRESS_OFFSET, 4
.equ FLI_CONFIG_DATA_LENGTH_OFFSET, 6
.equ FLI_CONFIG_BITMAP_DATA_OFFSET, 8
.equ FLI_CONFIG_SCREENS_DATA_OFFSET, 10
.equ FLI_CONFIG_COLOURS_DATA_OFFSET, 12
.equ FLI_CONFIG_BORDER_COLOUR_OFFSET, 14
.equ FLI_CONFIG_SCREEN_SIZE_OFFSET, 16
.equ FLI_CONFIG_GET_D021_COLOURS_FUN_PTR_OFFSET, 18

.equ FLI_CONFIG_TOTAL_SIZE, 26

.equ FLI_DESIGNER_LOAD_ADDRESS, 0x3c00
.equ FLI_DESIGNER_DATA_LENGTH, 0x4401
.equ FLI_DESIGNER_BITMAP_OFFSET, 0x2402
.equ FLI_DESIGNER_SCREENS_OFFSET, 0x0402
.equ FLI_DESIGNER_COLOURS_OFFSET, 0x0002
.equ FLI_DESIGNER_BORDER_COLOUR_OFFSET, 0xffff
.equ FLI_DESIGNER_SCREEN_SIZE, 0x0400

# struct IFLI {
#   FLI *fli_1;
#   FLI *fli_2;
# };
.equ IFLI_FLI_1_PTR_OFFSET, 0
.equ IFLI_FLI_2_PTR_OFFSET, 8

.equ IFLI_TOTAL_SIZE, 16
...
#   uint16_t screen_size;
# };
.equ IFLI_CONFIG_FORMAT_DESCRIPTION_OFFSET, 0
.equ IFLI_CONFIG_LOAD_ADDRESS_OFFSET, 4
.equ IFLI_CONFIG_DATA_LENGTH_OFFSET, 6
.equ IFLI_CONFIG_BITMAP_1_DATA_OFFSET, 8
.equ IFLI_CONFIG_SCREENS_1_DATA_OFFSET, 10
.equ IFLI_CONFIG_BITMAP_2_DATA_OFFSET, 12
.equ IFLI_CONFIG_SCREENS_2_DATA_OFFSET, 14
.equ IFLI_CONFIG_COLOURS_DATA_OFFSET, 16
.equ IFLI_CONFIG_GET_D021_COLOURS_FUN_PTR_OFFSET, 18
.equ IFLI_CONFIG_BORDER_COLOUR_OFFSET, 26
.equ IFLI_CONFIG_SCREEN_SIZE_OFFSET, 28

.equ IFLI_CONFIG_TOTAL_SIZE, 30

.equ FUN_PAINTER_LOAD_ADDRESS, 0x3ff0
.equ FUN_PAINTER_DATA_LENGTH, 0x839e
.equ FUN_PAINTER_BITMAP_1_OFFSET, 0x2012
.equ FUN_PAINTER_SCREENS_1_OFFSET, 0x0012
.equ FUN_PAINTER_BITMAP_2_OFFSET, 0x63fa
.equ FUN_PAINTER_SCREENS_2_OFFSET, 0x43fa
.equ FUN_PAINTER_COLOURS_OFFSET, 0x4012
.equ FUN_PAINTER_BORDER_COLOUR_OFFSET, 0xffff
.equ FUN_PAINTER_SCREEN_SIZE, 0x0400

.equ FUN_PAINTER_PACKED_FLAG_OFFSET, 0x0010
.equ FUN_PAINTER_ESCAPE_BYTE_OFFSET, 0x0011
.equ FUN_PAINTER_D021_COLOURS_1_OFFSET, 0x3f5a
.equ FUN_PAINTER_D021_COLOURS_2_OFFSET, 0x833a

.equ GUN_PAINTER_LOAD_ADDRESS, 0x4000
.equ GUN_PAINTER_DATA_LENGTH, 0x8343
.equ GUN_PAINTER_BITMAP_1_OFFSET, 0x2002
.equ GUN_PAINTER_SCREENS_1_OFFSET, 0x0002
.equ GUN_PAINTER_BITMAP_2_OFFSET, 0x6402
.equ GUN_PAINTER_SCREENS_2_OFFSET, 0x4402
.equ GUN_PAINTER_COLOURS_OFFSET, 0x4002
.equ GUN_PAINTER_BORDER_COLOUR_OFFSET, 0xffff
.equ GUN_PAINTER_SCREEN_SIZE, 0x0400

.equ GUN_PAINTER_D021_COLOURS_1_OFFSET, 0x3f51
.equ GUN_PAINTER_D021_COLOURS_2_OFFSET, 0x47ea
.equ GUN_PAINTER_D021_COLOURS_3_OFFSET, 0x47fd
